...
SECRET_KEY = 'django-insecure-mo@tndg!kvkpn9be361ti+64)s_tld9$tftzx!vvh4xr(hi#cs'
...
MDEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar': ["undo", "redo", "|",
                    ...
                    "h1", "h2", "h3", "h5", "h6", "|", "hr", "|", "link", "code",
                    "preformatted-text", "code-block", "table", "html-entities",
                    "pagebreak", "|", "info", "||", "watch", "fullscreen"],  # custom edit box toolbar
        'upload_image_formats': [],  # image upload format type
